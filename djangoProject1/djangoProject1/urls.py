...
router_V1.register('shippoints', ShipPointViewSet, basename='shippoints')
router_V1.register('shipstartpoint', StartRouteView, basename='shipstartpoint')
# path('api/start-nodes/', StartNodesView.as_view(), name='start_nodes_view'),
router_V1.register('shiproutes/end', EndRouteView, basename='endshiproute')
router_V1.register('shiproutes', ShipRoutePathsViewSet, basename='shiproute')
router_V1.register('editships', EditShipViewSet, basename='editshipview')
router_V1.register('editshippoints', EditPointViewSet, basename='editshippointsview')
router_V1.register('events/create', EventCreateViewSet, basename='eventscreate')
